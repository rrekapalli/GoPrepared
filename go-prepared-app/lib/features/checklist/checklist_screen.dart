...
class _ChecklistScreenState extends ConsumerState<ChecklistScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (checklist == null) {
      return Scaffold(
        appBar: AppBar(title: const Text('Preparation Checklist'), leading: BackButton(onPressed: () => popOrGo(context, '/journeys'))),
    ...
    return Scaffold(
      appBar: AppBar(
        leading: BackButton(onPressed: () => popOrGo(context, '/journeys/${widget.journeyId}/deck')),
